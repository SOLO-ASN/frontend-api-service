...
type campaignsHandler struct {
	retriever retriever.CampaigsnRetriever
}
...
func (h *campaignHandler) Query(c *gin.Context) {
	...
	res := h.retriever.Query(c)
	response := campaignQuery()
...
func campaignQuery(campaigns *[]model.Campaign, endCursor int, hasNextPage bool) types.CampaignQueryResponse {
