...
func (s spacesHandler) Query(c *gin.Context) {
	...
	res, err, endCursor := s.retriever.Query(c, form.Filters, form.First, form.After)
...
func spacesQueryResponse(spaces []model.Model, endCursor string, hasNextPage bool) *SpacesQueryResponse {
