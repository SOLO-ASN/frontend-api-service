...
type Campaign struct {
	...
	RewardName            string              `gorm:"column:reward_name;type:varchar(255)" json:"rewardName"`
	...
	ChildrenCampaigns     []Campaign          `gorm:"column:children_campaigns" json:"childrenCampaigns"`
